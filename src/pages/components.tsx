            ...
            <ol className="mt-8 space-y-6">
              <li className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <ButtonLink href="https://github.com/itishprasad30/typescript-nextjs-tailwindcss-stater/blob/main/src/styles/colors.css">
                    Check list of colors
                  </ButtonLink>
                </div>
                <div className="flex flex-wrap gap-3 text-xs font-medium">
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-50 text-black">
                    50
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-100 text-black">
                    100
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-200 text-black">
                    200
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-300 text-black">
                    300
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-400 text-black">
                    400
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-500 text-black">
                    500
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-600 text-white">
                    600
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-700 text-white">
                    700
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-800 text-white">
                    800
                  </div>
                  <div className="flex h-20 w-20 items-center justify-center rounded bg-primary-900 text-white">
                    900
                  </div>
                </div>
              </li>
              <li className="space-y-2">
                ...
                <div className="space-x-2">
                  ...
                  <UnstyledLink href="https://itishprasad-in.vercel.app">
                    Outside Links
                  </UnstyledLink>
                </div>
              </li>
              <li className="space-y-2">
                ...
                <div className="space-x-2">
                  ...
                  <PrimaryLink href="https://itishprasad-in.vercel.app">
                    Outside Links
                  </PrimaryLink>
                </div>
              </li>
